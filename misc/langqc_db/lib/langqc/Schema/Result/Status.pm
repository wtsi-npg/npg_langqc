use utf8;
package langqc::Schema::Result::Status;
...
Related object: L<langqc::Schema::Result::StatusDict>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:a/LPZh32pmvVUIBtsT/FWA
