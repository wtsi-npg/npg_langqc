...
def test_creating_qc_data_well(mlwhdb_test_session):
    ...
    assert qc.percentage_deplexed_bases["value"] == None, "Absent metrics mean this is set to none"
    assert qc.percentage_deplexed_reads["value"] == None, "Absent metrics mean this is set to none"
